...
export default (name, color, width, height) => {
  switch (name) {
    case 'search':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="49.5" height="49.5">
          ...
          />
          <path fill="none" fillRule="evenodd" stroke={color || '#632beb'} strokeLinecap="round" strokeWidth="3" d="M37.662 36.616l-8.826-8.32" />
        </svg>
      )
      break
    case 'profile':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width || '49.5'} height={height || '49.5'}>
          <path fill="none" fillRule="evenodd" stroke={color || '#632beb'} strokeWidth="3" d="M24.015 8.998A9.016 9.016 0 1 1 15 18.014a9.014 9.014 0 0 1 9.015-9.016z" />
          <path
            fill="none"
            fillRule="evenodd"
            stroke={color || '#632beb'}
    ...
    case 'menu':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="49.5" height="49.5">
          <path fill="#F5F5F5" fillRule="evenodd" stroke={color || '#632beb'} strokeLinecap="round" strokeWidth="3" d="M37.998 35.998h-28M37.998 15.998h-28M37.998 25.998h-28" />
        </svg>
      )
      break
    case 'headphone':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width || '49'} height={height || '49'} viewBox={`0 0 ${width * 1.6} ${height * 1.6}`}>
          <path fill="none" fillRule="evenodd" stroke={color || '#632beb'} strokeWidth="2" d="M13.998 26.997v-7c0-5.522 4.477-8.999 9.999-8.999h.001c5.523 0 10 3.477 10 8.999v7" />
          <path
            fill="none"
            fillRule="evenodd"
            stroke={color || '#632beb'}
