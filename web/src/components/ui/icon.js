...
export default (name, color, width, height) => {
  switch (name) {
    case 'search':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="49.5" height="49.5">
          ...
          />
          <path fill="none" fillRule="evenodd" stroke={color || '#8556F6'} strokeLinecap="round" strokeWidth="3" d="M37.662 36.616l-8.826-8.32" />
        </svg>
      )
      break
    case 'profile':
    ...
    case 'menu':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="49.5" height="49.5">
          <path fill="#F5F5F5" fillRule="evenodd" stroke={color || '#8556F6'} strokeLinecap="round" strokeWidth="3" d="M37.998 35.998h-28M37.998 15.998h-28M37.998 25.998h-28" />
        </svg>
      )
      break
    case 'headphone':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width || '49'} height={height || '49'} viewBox={`0 0 ${width * 1.6} ${height * 1.6}`}>
          <path fill="none" fillRule="evenodd" stroke={color || '#8556F6'} strokeWidth="2" d="M13.998 26.997v-7c0-5.522 4.477-8.999 9.999-8.999h.001c5.523 0 10 3.477 10 8.999v7" />
          <path
            fill="none"
            fillRule="evenodd"
            stroke={color || '#8556F6'}
