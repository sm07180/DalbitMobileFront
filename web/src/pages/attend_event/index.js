    ...
    <Layout {...props} status="no_gnb">
      <div id="attend-event">
        <div className="event-main">
          ...
          <button
            className={createCheckGift()}
            onClick={() => attendDateIn()}
          ></button>
        </div>
          ...
          <div className="event-content">
            <div className="content-left-wrap">
              ...
              <div className="detail-info-box">
                ...
                <p className="value">
                  <span>{summaryList.totalExp}</span> 개
                </p>
              </div>
            ...
            <div className="content-right-wrap">
              <div className="stamp-box">
                <ul className="stamp-box-list">
                  <li className="stamp-box-item success">
                  ...
                  <li className="stamp-box-item fail">
                    <div className="stamp-area">
                      <span>화요일</span>
                    </div>
        ...
        <div className="event-notice">
          ...
          <ul>
            <li>
              본 이벤트는 하루 동안 청취시간 또는 방송시간(종료된 방송방 기준)의
              누적된 합이 30분 이상인 대상에 한하여 1일 1회 참여가 가능합니다.
            </li>
            <li>매일 선물 테이블을 요일별 달성 시 해당 선물이 지급됩니다.</li>
            <li>매일 선물 테이블은 일주일 주기로 초기화됩니다.</li>
            <li>달 선물은 [마이페이지 > 내지갑]으로 자동 지급됩니다.</li>
            <li>
              보너스 랜덤 선물은 일주일을 모두 출석 체크한 대상에게 지급되며
              생성된 ‘더 줘!’ 버튼을 선택시 선물 받기가 완료됩니다.{' '}
            </li>
            <li>‘더 줘!’ 버튼은 일요일과 월요일에만 선택이 가능합니다.</li>
            <li>
              본 이벤트는 당사 정책에 따라 사전 고지 없이 변경 및 종료될 수
              있습니다.
            </li>
          </ul>
        </div>
