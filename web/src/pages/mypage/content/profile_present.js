...
import {
  ...
  setGlobalCtxMessage,
  setGlobalCtxMyInfo, setGlobalCtxUpdatePopup,
  setGlobalCtxUpdateProfile, setGlobalCtxVisible
...
export default (props) => {
  ...
  const broadCastCharge = () => {
    ...
    dispatch(setGlobalCtxUpdatePopup({popup:['APPDOWN', {
  ...
  useEffect(() => {
    dispatch(setGlobalCtxUpdatePopup('CHARGE'))
