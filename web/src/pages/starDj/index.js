        ...
        if (djInfo.data){
          ...
          if (nowDate >= startDate && nowDate <= endDate){
            ...
            if (UtilityCommon.eventDateCheck("20220510")){
              setEventInfo({...djInfo.data.eventInfo, stat: getStat(djInfo.data.eventInfo), myStat: {...myPoint.data, play_cnt: typeof myPoint.data?.play_cnt === "undefined" ? 0 : Math.ceil(myPoint.data.play_cnt / 60 / 60)}, already: djInfo.data.specialDjCondition.already});
            } else {
