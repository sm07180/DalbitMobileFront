      ...
      <div
        ...
        <div className="footerWrap">
          <ul className="infoList">
            <li className="infoItem" onClick={() => history.push("/customer/appInfo/service")}>이용약관</li>
            <li className="infoItem" onClick={() => history.push("/customer/appInfo/privacy")}>개인정보</li>
            <li className="infoItem" onClick={() => history.push("/customer/appInfo/youthProtect")}>청소년보호</li>
            <li className="infoItem" onClick={() => history.push("/customer/appInfo/operating")}>운영정책</li>
            <li className="infoItem" onClick={() => history.push("/service")}>고객센터</li>
          </ul>
