      ...
      <div className="content-wrap">
        <div className="each-line">
          <p className="text">
            안녕하세요! 달빛라이브입니다. <br />
            <br />
            오픈베타 기간에도 서비스를 이용해주심에 진심으로 감사를 드립니다. 예상치 못할 정도의 많은분이 이용해주셨는지 미디어
            서버에 문제가 발생하였습니다. 이용하시는데 불편을 드려 너무 죄송한 마음입니다.
            <br />
            <br />
            이 문제로 소리가 들리지 않거나 방입장에 문제가 발생하고 있습니다. 현재 서버 재부팅 및 서버 증설 등 조치를 취하고
            있습니다.
            <br />
            <br />
            불편하시더라도 조금만 참아주시고, 넓은아량으로 이해해주시기를 부탁드립니다. 잠을 안자고서라도 작업에 임해 정식오픈을
            앞당기도록 하겠습니다.
            <br />
            <br />- 달빛라이브 운영자 올림
          </p>
