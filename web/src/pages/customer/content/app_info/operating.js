...
export default function Operating() {
  return (
    <div className="termsWrap operating">
      ...
      <h3>콘텐츠 규제</h3>
      <p>
        달빛 라이브에서는 쾌적한 서비스 운영을 위해 서비스 운영정책을 기준으로 콘텐츠를 규제하고 있습니다. 라이브 방송과
        녹음파일은 실시간으로 모니터링하고 있으며, 운영정책을 위반한 방송/청취자는 이용 제한이나 라이브 방송이 즉시 종료가 될 수
        있고, 게시된 녹음파일, 이미지, 게시글 등이 삭제될 수 있습니다.
        <br />
          ...
          <ol className="depth2">
            ...
            <li>
              ...
              <ol className="depth3">
                ...
                <li>
                  <span>②</span>판권이 없는 음악, 녹음 방송, 스포츠, 영화, 애니메이션, TV채널 등의 저작권 침해 행위
                </li>
                <li>
