...
export default function Operating() {
  return (
    <div className="termsWrap operating">
      ...
      <h3>콘텐츠 규제</h3>
      <p>
        달빛 라이브에서는 쾌적한 서비스 운영을 위해 서비스 운영정책을 기준으로 콘텐츠를 규제하고 있습니다. 라이브 방송과 저장
      ...
      <ol className="depth1">
        <li>
          <span>1.</span>항목 : 저작권 위반 물, 음란물/폭력/위법내용/청소년 유해/저작권 침해/미풍양속 위배/명예훼손/기타/자체 기준
          위반
          <ol className="depth2">
            <li>
              <span>가)</span>음란물
            ...
            <li>
              ...
              <ol className="depth3">
                ...
                <li>
                  <span>⑤</span>청소년 접근 제한 서비스 (유해곡, 유해영상, 청소년 출입금지업소, 유해사이트 등) 이용 방송
                </li>
                <li>
            ...
            <li>
              ...
              <ol className="depth3">
                <li>
                  <span>①</span>저작권자로부터 권리침해 신고가 접수된 저작물 침해 행위 (게시, 편집, 배포, 전송 등)
                </li>
                <li>
                  <span>②</span>판권이 없는 음악, 저장파일, 방송, 스포츠, 영화, 애니메이션, TV 채널 등의 저작권 침해 행위
                </li>
                <li>
                  <span>③</span>저작권 보호 기간이 만료되지 않은 저작물 침해 행위
                </li>
                <li>
                  <span>④</span>저작권법의 보호를 받는 산업재산권 무단 사용 (게시, 편집, 배포, 전송 등)
                </li>
                <li>
                  <span>⑤</span>원저작자의 허락을 받지 않은 저작물 무단 사용 (게시, 배포, 전송 등)
                </li>
                <li>
            ...
            <li>
              ...
              <ol className="depth3">
                <li>
                  <span>①</span>지나치게 과도한 욕설과 부적절한 언어, 혐오, 잔혹, 폭력성 내용이 포함된 부적절한 방송 또는 파일
                </li>
                <li>
                  <span>②</span>동물 학대 또는 생명을 앗아가는 내용이 포함된 부적절한 방송 또는 파일
                </li>
                <li>
                  <span>③</span>고의적이고 지속적으로 선정적 요소가 포함된 방송 또는 파일
                </li>
                <li>
                  <span>④</span>심각한 기물 파손 혹은 훼손 방송 또는 파일
                </li>
                <li>
                  <span>⑤</span>자해/자살 암시 및 타인에 대한 상해 흉기를 사용하여 신체를 손상하는 잔혹한 방송 또는 파일
                </li>
                <li>
                  <span>⑥</span>위법으로 보기는 어려우나 보편적인 사회 질서를 해치거나 도의적으로 허용되지 않는 방송 또는 파일
                </li>
                <li>
                  <span>⑦</span>금품, 아이템, 추천 등의 대가로 선정적인 연출을 하는 방송 또는 파일
                </li>
                <li>
                  <span>⑧</span> 위 항목 외 미풍양속 위배 행위가 포함된 방송 또는 파일
                </li>
              </ol>
            </li>
            <li>
                ...
                <li>
                  ...
                  <ol className="depth4">
                    <li>
                      ...
                      모욕, 학대, 착취, 유기, 따돌림, 감금, 폭행, 욕설 등 이와 유사한 모든 행위를 포함하는 내용
                    </li>
                    <li>
                      <span>-</span>신체적, 정신적 장애를 가지고 있는 장애인 또는 장애인 관련자를 집단 따돌림을 가하거나 유발하는
                      내용
                    </li>
                    <li>
                      <span>-</span>장애를 가지고 있는 장애인 또는 장애인 관련자를 괴롭히거나 금전적인 착취, 유기, 학대를 하거나
                      유발하는 내용
                    </li>
                    <li>
                    ...
                    <li>
                      <span>-</span>위 항목 외 장애인 비하 행위에 포함되는 내용
                    </li>
                  </ol>
                </li>
                <li>
                  ...
                  <ol className="depth4">
                    ...
                    <li>
                      <span>-</span>특정인종, 지역, 종교에 대한 차별 용어를 직접적으로 언급하거나 비하하는 내용
                    </li>
                    <li>
            ...
            <li>
              ...
              <ol className="depth3">
                <li>
                  <span>①</span>서비스 운영을 방해하거나 서비스에 악영행을 끼치는 행위
                </li>
                <li>
                  <span>②</span> 회사와 협의되지 않은 국내/외 라이브 스트리밍 서비스의 홍보 및 사이트 가입 및 이용 등을 유도하는
                  내용
                </li>
                <li>
                ...
                <li>
                  <span>⑤</span> 다른 DJ의 콘텐츠를 허락 없이 임의로 송출하는 행위 (도방)
                </li>
                <li>
                  <span>⑥</span> 타인이 대리하여 콘텐츠를 진행하는 행위 (대리방송)
                </li>
                <li>
                  <span>⑦</span> 회사에서 콘텐츠 제작 지원을 목적으로 제공한 아이템을 판매해서 금전적인 이득을 취하는 행위
                </li>
                <li>
                  <span>⑧</span> 서비스 명칭 또는 서비스의 운영진을 사칭하여 유저를 속이거나 이득을 취하는 등 피해와 혼란을 주는
                  행위
                </li>
                <li>
                  <span>⑨</span> 욕설, 협박, 분위기조성을 통해 단체 (크루, 팸, 군단 등) 가입을 강요/압박하여 심리적 부담/고통을
                  주는 경우
                </li>
                <li>
      ...
      <p className="desc">
        *회원이 기업체와 계약을 맺지 않고, 방송 내에서 당 서비스를 홍보하는 행위는 회원의 자발적 행위로 판단하여 당 회사는 일체의
        ...
        <br />
        <span>
          ※ 경고 및 이용정지, 정지기간은 운영정책 위반 사안 및 수위, 내용의 경중에 따라 결정됩니다.
          <br />※ 사회적 물의 및 서비스 이미지에 치명적인 실추 등 정책 위반 사안이 매우 중대한 경우는 이전 경고 및 정지 이력 등에
          관계없이 즉시 영구정지 처리됩니다.
        </span>
      </p>
      <ol className="depth1">
              ...
              <ol className="depth3">
                ...
                <li>
                  ...
                  <ol className="dpeth4">
                    ...
                    <li>
                      <span>-</span>DJ가 규정을 준수한 동시에 시청자도 규정을 준수해야 함. (게스트 참여 시 포함)
                    </li>
                    <li>
