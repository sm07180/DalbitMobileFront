  ...
  return (
    <div className="termsWrap operating">
      ...
      <p>
        ...
        녹음파일은 실시간으로 모니터링하고있으며, 운영정책을 위반한 방송/청취자는 이용제한이나 라이브 방송이 즉시 종료가 될 수
        있고, 게시된 녹음파일, 이미지, 게시글 등이 삭제될 수 있습니다. 따라서, 다음의 규제 항목을 위반하지 않도록 준수하여야
        합니다.
      </p>

      <ol className="depth1">
        <li>
          <span>1.</span>항목 : 저작권 위반물, /미풍양속 위배/명예훼손/기타/자체 기준위반
          <ol className="depth2">
            <li>
              <span>가)</span>음란물
              <ol className="depth3">
      ...
      <p>
        부칙
        <br />
        6. 본 운영정책 Ver 1.5는 2020년 09월16일부터 적용됩니다.
        <br />
