  ...
  return (
    <Layout status="no_gnb">
      <div id="pcService">
        ...
        />
        <img
          src="https://image.dalbitlive.com/event/pc_service/mobile/m_service02.jpg"
          alt="장점 확인하기, 고품격 스테레오 음질의 방송 가능, 블루스택, 녹스 필요 엊ㅄ다! 다이렉트 방송 & 청취 가능!"
        />
        <img
          src="https://image.dalbitlive.com/event/pc_service/mobile/m_service03.jpg"
          alt="채팅방과 방송방 내 모든 정보를 동시에 확인 가능!, 간편한 외부 콘텐츠 활용!, 큰 화면으로 소통 가능!"
        />
        <img
          src="https://image.dalbitlive.com/event/pc_service/mobile/m_service04.jpg"
