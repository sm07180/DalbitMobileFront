  ...
  return (
    <>
      ...
      <section className="deadlineWrap">
        ...
        <InputItems>
          <input type="tel" placeholder="직접 입력" value={voteRdx.tempInsVote.endTime < 1 ? '' : voteRdx.tempInsVote.endTime} onChange={event => {
            if(event.currentTarget.value === ''){
              dispatch(setTempInsVote({
                ...voteRdx.tempInsVote, endTime: 0
              }))
            }else if(/^[0-9\b]+$/.test(event.currentTarget.value)){
