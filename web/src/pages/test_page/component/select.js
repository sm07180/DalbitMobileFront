...
//     background: url(${IMG_SERVER}/images/api/ico_selectdown_g_s.png) no-repeat right;

//     padding: 2px 30px 2px 10px;
//     color: ${props => (props.color ? `${props.color};` : '#632beb;')}
...
//     &:focus {
//         background: url(${IMG_SERVER}/images/api/ico-selectup-g.png) no-repeat right;
//         outline: none;
//         border-bottom: 0px;
//     }
