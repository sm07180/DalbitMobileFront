...
import {setGlobalCtxMessage, setGlobalCtxWalletAddData, setGlobalCtxWalletAddHistory} from "redux/actions/globalCtx";
...
const WalletPage = (props) => {
  ...
  const getWalletHistory = () => {
    ...
    dispatch(setGlobalCtxWalletAddHistory({listHistory: [], popHistory: []}));
