    ...
    <React.Fragment>
      <div className="wizard">
        <div className="wizard_info" style={{minHeight: '330px'}}>
          <img src="https://image.dalbitlive.com/event/moonrise/moonrise_fullmoon_dj.png" alt="문법사 보상 이미지" />
              ...
              return (
                <div key={idx} className="listItem" onClick={() => history.push(`/profile/${mem_no}`)}>
                  ...
                  <div className={idx > 2 ? 'moonCntWrap' : 'moonCntWrap ranker'}>
                    <img src="https://image.dalbitlive.com/event/moonrise/ic_dj_fullmoon.png" alt="문카운트이미지" />
