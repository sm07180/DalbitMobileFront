    ...
    <>
      ...
      <Content id="postGuideWrap">
        <div className="postGuideNotice">
          ...
          <img src="https://image.dallalive.com/event/post_guide/210119/postguide_01.png" alt="메시지 우수회원 이벤트" />
          <div className="text">
        ...
        <div className="postGuideSearch">
          <img src="https://image.dallalive.com/event/post_guide/210115/postguide_02.png" alt="대화상대 찾기" />
          <div className="text">
        ...
        <div className="postGuideCommunity">
          <img src="https://image.dallalive.com/event/post_guide/210115/postguide_03.png" alt="직접 대화하기" />
          <div className="text">
        ...
        <div className="postGuidePoint">
          <img src="https://image.dallalive.com/event/post_guide/210115/postguide_04.png" alt="1:1대화 주요기능" />
          <ol className="text">
        ...
        <div className="postGuideThumbnail">
          <img src="https://image.dallalive.com/event/post_guide/210115/postguide_05.png" alt="이미지 확인하기" />
          <div className="text">1:1 대화창에서 이미지를 클릭하면 이미지를 확대해서 볼 수 있어요.</div>
        </div>
        <div className="postGuideOption">
          <img src="https://image.dallalive.com/event/post_guide/210115/postguide_06.png" alt="신고/차단/나가기" />
          <div className="text">
