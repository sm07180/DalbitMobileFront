    ...
    <>
      ...
      <Content id="postGuideWrap">
        ...
        <div className="postGuideSearch">
          ...
          <div className="text">
            우체통 상단의 아이콘을 클릭하거나 버튼을 클릭하여 대화할 팬/스타를 클릭하면 해당 회원과 대화가 시작됩니다. 추후
        ...
        <div className="postGuideCommunity">
          ...
          <div className="text">
            대화하고 싶은 회원의 미니프로필이나 프로필 페이지 우측 상단의 우체통 아이콘을 클릭하면 바로 해당 회원과 1:1 대화가
            가능합니다
          </div>
        </div>
        ...
        <div className="postGuideOption">
          ...
          <div className="text">
            ...
            <p>
              앞으로 더 나은 우체통 서비스를 제공하기 위해 지속적인 기능 개발 및 개선이 이루어질 예정입니다. 1:1 문의를 통해
              우체통 서비스에 대한 의견 주시면 적극 반영하겠습니다. 달빛라이브 우체통 많이 사랑해주세요😉❣
            </p>
          </div>
        </div>
      </Content>
