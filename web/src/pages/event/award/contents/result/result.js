  ...
  return (
    <>
      <div className="topBox">
        ...
        <img src="https://image.dalbitlive.com/event/award/201214/main-result.png" className="topBox__mainImg" alt="main Image" />
      </div>

      <div className="tabBox result">
        <button className={`btn ${tabState === RESULT_TYPE.DJ && 'active'}`} onClick={() => setTabState(RESULT_TYPE.DJ)}>
          <img src="https://image.dalbitlive.com/event/award/201214/tab_dj_top.png" />
        </button>
        <button className={`btn ${tabState === RESULT_TYPE.FAN && 'active'}`} onClick={() => setTabState(RESULT_TYPE.FAN)}>
          <img src="https://image.dalbitlive.com/event/award/201214/tab_fan_top.png" />
        </button>
      </div>
