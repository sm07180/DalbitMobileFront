  ...
  return (
    <>
      ...
      <div id="customerNotice">
        ...
        <ul className="point">
          <li>
            <strong className="tit">시행일자</strong> <strong className="color_red">2020년 12월 23일 (수)</strong>
          </li>
          <li>
            <strong className="tit">보관항목</strong>
            <span>
              회원가입 시 또는 회원정보 수정으로
              <br />
              수집하고 관리되는 모든 정보
        ...
        <div className="subNotice">
          <strong className="color_red"> 2020년 12월 22일(화) 00시 이전</strong>까지 까지 달빛라이브 앱/웹에
          <strong> 1회 이상 로그인하시면 자동 휴면전환 회원 대상에서 제외</strong>됩니다
        </div>
