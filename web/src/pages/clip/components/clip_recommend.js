    ...
    if (
      ...
      return (
        <button
          className="allPlay"
          onClick={() => {
            ClipPlayFn(marketingClipList[0].clipNo, 'all', globalState, history)
              ...
              <>
                ...
                <div className="play">
                  ...
                  <div
                    className="video"
                    onClick={() => {
                      ClipPlayFn(marketingClipObj.clipNo, 'dal', globalState, history)
                      dispatch(setGlobalCtxDateState(marketingClipObj.recDate))
                    }}>
                    ...
                    return (
                      <li className="playBox__list" key={`list-${i}`}>
                        <div
                          className="thumbnail"
                          onClick={() => {
                            ClipPlayFn(v.clipNo, 'dal', globalState, history)
                            dispatch(setGlobalCtxDateState(marketingClipObj.recDate))
                          }}>
