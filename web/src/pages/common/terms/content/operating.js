...
export default props => {
  ...
  return (
    <Content>
      ...
      <h3>운영정책의 목적</h3>
      <p>
        본 운영 정책은 ㈜인포렉스(이하 회사라 함)가 제공하는 실시간 오디오 라이브 방송 서비스에 적용되며, 이용자와 회사가
        준수하여야 할 기본적인 사항을 규정하여 원활한 서비스를 제공하는 것을 목적으로 합니다.
      </p>

      <h3>운영정책의 적용</h3>
      <p>
        본 운영정책은 회사가 제공하는 각 서비스 별 별도 정책이나 특별한 규정이 있는 경우를 제외하고는 본 정책이 우선 적용됩니다.
        또한 운영정책에 언급되지 않은 사항은 「모바일 서비스 이용 약관」, 「개인정보처리방침 및 청소년 보호 정책」 및 대한민국
        법률에 의거하여 처리됩니다.
        <br />
      ...
      <h3>콘텐츠 규제</h3>
      <p>
        달빛라디오에서는 쾌적한 서비스 운영을 위해 서비스 운영정책을 기준으로 콘텐츠를 규제하고 있습니다. Live 방송의 이미지,
