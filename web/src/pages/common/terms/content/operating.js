        ...
        <li>
          ...
          <ol className="depth2">
            <li>
              ...
              <ol className="depth3">
                <li>
                  <span>①</span> 성행위 및 유사 성행위를 묘사 하는 이미지, 행위(신음소리 등)
                </li>
                <li>
                  <span>②</span>성적인 사진, 신체(유두,성기,음모 등) 이미지, 도구(예 : 자위도구)를 화면에 노출
                </li>
                <li>
                  <span>③</span>음란 방송을 진행하는 조건으로 금품, 유료 아이템, 추천 등을 요구하는 행위
                </li>
                <li>
                  <span>④</span>방송에서 음란성 대화 (성적 이야기, 성적 질문, 성적 만남 유도, 신체관련 질문 등)를 하는 경우
                </li>
                <li>
                  <span>⑤</span>조건 만남 또는 성매매 등의 조건(금액/장소)을 홍보하는 행위
                </li>
                <li>
                  <span>⑥</span>위 항목 외 음란 행위가 포함된 경우
                </li>
              </ol>
            </li>
            <li>
              ...
              <ol className="depth3">
                <li>
                  <span>①</span>방송 및 랭킹을 조작하는 행위
                </li>
                <li>
                  <span>②</span>다수의 계정을 통해 하나의 계정으로 달/별을 수집하는 행위
                </li>
              </ol>
            </li>
            <li>
              ...
              <ol className="depth3">
                <li>
                  <span>①</span>불법 사설 온라인 스포츠 배팅, 도박 영업, 게임 머니 환전을 홍보하는 행위
                </li>
                <li>
                  <span>②</span>음란성 사업장 및 퇴폐업소 공유 및 홍보하는 행위
                </li>
                <li>
                ...
                <li>
                  <span>⑥</span>위 항목 외 법령에 위반되는 행위를 저지르거나 조장하여 법질서를 해할 우려가 있는 행위
                </li>
                <li>
            ...
            <li>
              ...
              <ol className="depth3">
                <li>
                  ...
                  <ol className="depth4">
                    <li>
                      <span>-</span>공공연히 타인을 모욕하거나 타인의 명예를 훼손하는 행위
                    </li>
                    <li>
                    ...
                    <li>
                      <span>-</span>위 항목 외 명예훼손 내용이 포함 되는 경우
                    </li>
                  </ol>
                </li>
                <li>
                  ...
                  <ol className="depth4">
                    ...
                    <li>
                      <span>-</span>불특정 다수인을 가리켜 장애인이라고 지칭하는 발언의 방송을 하는 행위
                    </li>
                  </ol>
                </li>
                <li>
                  ...
                  <ol className="depth4">
                    <li>
                      <span>-</span>합리적 이유 없이 특정 지역, 종교, 인종 등을 차별하거나 이에 대한 편견을 조장하는 행위
                    </li>
                    <li>
                      <span>-</span>인종, 지역, 종교 파별 용어를 직접적으로 언급하거나 비하하는 행위
                    </li>
                    <li>
                      <span>-</span>성별의 차이를 두어 남녀간의 분쟁을 조장하는 행위
                    </li>
                  </ol>
                </li>
              </ol>
            ...
            <li>
              ...
              <ol className="depth3">
                ...
                <li>
                  <span>②</span>회사와 협의되지 않은 라이브 스트리밍 서비스 홍보 및 사이트 가입 및 이용 등을 유도하는 행위
                  (국내/외 플랫폼 포함)
                </li>
                <li>
        ...
        <li>
          ...
          <ol className="depth2">
            ...
            <li>
              ...
              <ol className="depth3">
                <li>
                  <span>①</span>부계정을 이용한 방송순위, 각 랭킹 및 달, 별을 조작하여 수집하는 등의 위반행위
                </li>
                <li>
                  <span>②</span>반정부/반국가적 발언 또는 정부/국가를 모욕/비방하는 행위
                </li>
                <li>
                  <span>③</span>생명과 건강을 위협하는 행위, 성행위, 음란 활동 혹은 권리 침해, 정치와 관련된 생방송, 녹화방송 또는
                  매음 광고 등
                </li>
                <li>
                  <span>④</span>각종 경로를 통해서 신체 민감한 부위를 보여주는 행위(예 : 민감한 부위를 만지는 행위, 여성의 가슴,
                ...
                <li>
                  <span>⑨</span>테러리즘, 극단주의, 전쟁 주장, 종교 선동 등 언론과 행위
                </li>
                <li>
                  <span>⑩</span>각종 경로를 통해서 성인용품, 성 보건품, 알바 사기 등 홍보하는 행위
                </li>
              </ol>
            ...
            <li>
              ...
              <ol className="depth3">
                ...
                <li>
                  ...
                  분위기를 만드는 행위/불법 광고나 서비스 규정을 어기는 광고(예 : 성인용품, 총기류, 활과 화살, AV, 보건 제품,
                  담배, 불법 의약품, 성병 치료 등 광고 내용)
                </li>
                <li>
                  <span>④</span>방송 환경
                  <ol className="dpeth4">
