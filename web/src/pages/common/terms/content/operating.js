...
export default props => {
  ...
  return (
    <Content>
      ...
      <h3>운영정책의 목적</h3>
      <p>
        본 운영 정책은 ㈜인포렉스(이하 회사라 함)가 제공하는 실시간 오디오 라이브 방송 서비스에 적용되며, 이용자와 회사가 준수하여야 할 기본적인 사항을 규정하여 원활한 서비스를 제공하는 것을 목적으로
        합니다.
      </p>

      <h3>운영정책의 적용</h3>
      <p>
        본 운영정책은 회사가 제공하는 각 서비스 별 별도 정책이나 특별한 규정이 있는 경우를 제외하고는 본 정책이 우선 적용됩니다. 또한 운영정책에 언급되지 않은 사항은 「모바일 서비스 이용 약관」,
        「개인정보처리방침 및 청소년 보호 정책」 및 대한민국 법률에 의거하여 처리됩니다.
        <br />
        이용자는 본 운영정책을 준수해야 하며, 위반 시에는 각 규정에 의거하여 계정에 불이익이 발생할 수 있습니다.
      </p>

      <h3>콘텐츠 규제</h3>
      <p>달빛라디오에서는 쾌적한 서비스 운영을 위해 서비스 운영정책을 기준으로 콘텐츠를 규제하고 있습니다. Live 방송의 이미지, 문자, 음성과 계정 관련한 정보 닉네임, 고유아이디 등 모두 포함됩니다.</p>
          ...
          <ol className="depth2">
            <li>
              ...
              <ol className="depth3">
                ...
                <li>음란 방송을 진행하는 조건으로 금품, 유로 아이템, 추천 등을 요구하는 행위</li>
            ...
            <li>
              ...
              <ol className="depth3">
                ...
                <li>
                  ...
                  <ol className="depth4">
                    <li>
                      신체적, 정신적 장애를 가지고 있는 장애인 또는 장애인 관련자에게 모욕감을 주거나 비하, 멸시, 모욕, 학대, 착취, 유기, 따돌림, 감금, 폭행, 욕설 등 이와 유사한 모든 행위를 포함하는
                      방송
                    </li>
                    <li>장애인의 특정 신체나 행위를 비판 또는 비하하는 발언이나 성적 수치심을 자극하는 언어 표현, 희롱하는 발언을 하는 행위</li>
            ...
            <li>
              ...
              <ol className="depth3">
                ...
                <li>회사와 협의되지 않은 라이브 스트리밍 서비스 홍보 및 사이트 가입 및 이용 등을 유도하는 행위 (국내/외 플랫폼 포함)</li>
      ...
      <p>
        *회원과 기업체와 개인적으로 계약을 맺어 방송에서 홍보하는 것은 해당 회원의 책임 및 판단 하에 진행하는 것으로 자발적 거래행위 등에 대해 회사는 책임지지 않으며 또한 관련 회원 분쟁에 관여하지
        않습니다. 다만, 회사에서 홍보 횟수나 방송 내 일정 시간 등을 제한할 수 있습니다.
      </p>
      <ol className="depth1">
        <li>
          ...
          <ol className="depth2">
            ...
            <li>
              ...
              <ol className="depth3">
                ...
                <li>생명과 건강을 위협하는 행위, 성행위, 음란 활동 혹은 권리 침해, 정치와 관련된 생방송, 녹화방송 또는 매음 광고 등</li>
                <li>각종 경로를 통해서 신체 민감한 부위를 보여주는 행위(예 : 민감한 부위를 만지는 행위, 여성의 가슴, 남녀 둔부, 허벅지 안쪽, 성기를 보여주는 행위, 시스루 복장 등</li>
            ...
            <li>
              ...
              <ol className="depth3">
                ...
                <li>
                  발언 : 타인을 비방 혹은 모욕하는 내용/타인을 희롱하는 내용/음란, 저속한 내용 전파 혹은 저속한 분위기를 만드는 행위/불법 광고나 서비스 규정을 어기는 광고(예 : 성인용품, 총기류, 활과
                  화살, AV, 보건 제품, 담배, 불법 의약품, 성병 치료 등 광고 내용)
                </li>
                <li>
                  방송 환경
                  <ol className="dpeth4">
      ...
      <p>
        *A등급 제재의 경우 유저 계정과 소유하신 모바일 디바이스를 차단하여 앱 실행 자체를 영구적으로 제재 받게 됩니다.
        <br />
      ...
      <table className="content">
        <caption>항목(음란물, 위법행위, 청소년 유해, 저작권 침해, 미풍양속 위배, 명예훼손, 광고, 자체 기준 위반), 제재 조치에 따른 내용을 나타낸 표</caption>
        <colgroup>
          <col style={{width: '25%'}} />
          <col style={{width: '25%'}} />
          <col style={{width: '25%'}} />
