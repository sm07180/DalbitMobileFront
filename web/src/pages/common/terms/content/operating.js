        ...
        <li>
          ...
          <ol className="depth2">
            ...
            <li>
              부계정
              <ol className="depth3">
                <li>방송 및 랭킹을 조작하는 행위</li>
                <li>다수의 계정을 통해 하나의 계정으로 달/별을 수집하는 행위</li>
              </ol>
            </li>
            <li>
              위법행위
            ...
            <li>
              ...
              <ol className="depth3">
                ...
                <li>회사와 협의되지 않은 영업 활동 기업 및 단체, 개인과 그에 소속되어 당사 플랫폼에서 방송 송출을 하는 행위</li>
        ...
        <li>
          ...
          <ol className="depth2">
            ...
            <li>
              ...
              <ol className="depth3">
                <li>부계정을 이용한 방송순위, 각 랭킹 및 달, 별을 조작하여 수집하는 등의 위반행위</li>
