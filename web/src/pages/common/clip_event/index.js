  ...
  return (
    <div id="clipOpenPopup">
      ...
      <div className="content">
        ...
        <ul>
          <li>
            오픈 일 기준 7일간 등록된 클립들에 대해 이벤트 기간동안 받은 조회수 1회 – 1점, 좋아요 수 1회 – 2점, 받은 선물 별 1개 -
            1점을 적용하여 상위 10명의 인원에게 달을 지급합니다.
          </li>
          <li>이벤트 보상은 이벤트 기간 종료 후 9월 00일 공지사항을 통해 공지 후 일괄 지급됩니다.</li>
        </ul>
        <h3>유의사항 안내</h3>
        <ul>
