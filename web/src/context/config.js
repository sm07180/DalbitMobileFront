 ...
 * @brief 서버분기
 */
export const SERVICE_SERVER = 'https://devwww.dalbitcast.com' //서비스서버
export const API_SERVER = window.location.port === '44443' ? 'https://devapi.dalbitcast.com:44443' : 'https://devapi.dalbitcast.com' //API서버
