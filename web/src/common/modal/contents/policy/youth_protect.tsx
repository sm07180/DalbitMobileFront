    ...
    <div className="fanlist-modal" onClick={(e) => e.stopPropagation()}>
      ...
      <DalbitScroll width={500} height={750} displayClassName="fanListWrapper">
        <div className="termsWrap">
          <h2>청소년 보호정책</h2>
          <p>
            (주)여보야(이하 “회사”라 함)는 청소년이 안전한 인격체로 성장할 수 있도록 하기 위하여 정보통신망이용촉진 및
            정보보호에 관한법률 및 청소년보호법에 근거하여 청소년보호정책을 수립, 시행하고 있습니다. <br />
            <br />
          ...
          <p>
            회사는 청소년보호와 관련한 업무 담당자를 대상으로 정보통신망이용촉진 및 정보보호에 관한법률 및 청소년보호법 등
            청소년보호 관련 법령과 유해정보 발견 시 처리 방법, 위반사항 처리에 대한 보고절차 등을 교육하고 있습니다.
          </p>
          <h3>03. 유해성 정보로 인한 피해상담 및 고충처리</h3>
          <p>
            회사는 청소년 유해정보로 인한 피해 상담 및 고충처리를 위하여 담당 인력을 배치하여 그 처리에 만전을 기하고 있으며,
            피해의 확산을 방지하고자 최선의 노력을 다하고 있습니다. 청소년 유해매체물의 신고 및 피해상담, 고충처리 등 청소년보호와
            관련한 문제는 청소년보호센터에 관련 내용을 접수하시거나 아래의 청소년보호 책임자 및 담당자에게 연락하여 주시면
            신속하고 공정하게 처리하도록 하겠습니다.
          </p>
          <br />
          <p>
            청소년보호책임자
